...
EVENT_SPECS: dict[str, OperationalEventSpec] = {
    ...
    "usage_completed": OperationalEventSpec(
        source_layer="processing",
        event_category="usage",
        severity="info",
        is_alert=False,
        title_en="Usage calculation completed",
        title_ko="사용량 계산 완료",
        message_en="Usage calculation completed successfully.",
        message_ko="사용량 계산이 완료되었습니다.",
    ),
    "usage_failed": OperationalEventSpec(
        source_layer="processing",
        event_category="usage",
        severity="error",
        is_alert=True,
        title_en="Usage calculation requires attention",
        title_ko="사용량 계산 주의 필요",
        message_en="Usage calculation completed with issues.",
        message_ko="사용량 계산이 문제를 포함한 상태로 끝났습니다.",
    ),
    "bill_determinant_completed": OperationalEventSpec(
        source_layer="processing",
        event_category="bill_determinant",
        severity="info",
        is_alert=False,
        title_en="Bill determinant calculation completed",
        title_ko="청구 결정값 계산 완료",
        message_en="Bill determinant calculation completed successfully.",
        message_ko="청구 결정값 계산이 완료되었습니다.",
    ),
    "bill_determinant_failed": OperationalEventSpec(
        source_layer="processing",
        event_category="bill_determinant",
        severity="error",
        is_alert=True,
        title_en="Bill determinant calculation requires attention",
        title_ko="청구 결정값 계산 주의 필요",
        message_en="Bill determinant calculation completed with issues.",
        message_ko="청구 결정값 계산이 문제를 포함한 상태로 끝났습니다.",
    ),
    "bill_charge_completed": OperationalEventSpec(
        source_layer="processing",
        event_category="bill_charge",
        severity="info",
        is_alert=False,
        title_en="Bill charge calculation completed",
        title_ko="청구 금액 계산 완료",
        message_en="Bill charge calculation completed successfully.",
        message_ko="청구 금액 계산이 완료되었습니다.",
    ),
    "bill_charge_failed": OperationalEventSpec(
        source_layer="processing",
        event_category="bill_charge",
        severity="error",
        is_alert=True,
        title_en="Bill charge calculation requires attention",
        title_ko="청구 금액 계산 주의 필요",
