...
- `mdms-preproduct-stale-warning-second-pass-plan.md` defines the next narrow visibility slice for replay failure wording, correction blocked-guidance fallback, and auto-refresh-versus-intervention wording cleanup.
