...
- operator-managed HES system registration and source identity
...
- The architecture should distinguish between operator-managed HES systems, payload-normalization adapter profiles, and runtime adapters that manage actual source connectivity.
